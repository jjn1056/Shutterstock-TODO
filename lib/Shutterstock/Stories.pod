...
As a person, I want a TODO list so that I can track jobs I need to do.

As a person with a TODO list, I need to retrieve my unfinished jobs so I know
what needs work.
...
As a person with a TODO list, I’d like to categorize my list by one of (bugs,
